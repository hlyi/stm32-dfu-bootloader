...
CONFIG ?= -DWINUSB_SUPPORT -DENABLE_GPIO_DFU_BOOT -DGPIO_DFU_BOOT_PORT=GPIOB -DGPIO_DFU_BOOT_PIN=2 -DGPIO_DFU_BOOT_PIN_NOPD -DENABLE_CH32F103 -DENABLE_DFU_UPLOAD -DUSE_BACKUP_REGS -DENABLE_LED_STATUS -DGPIO_LED_STATUS_PORT=GPIOC -DGPIO_LED_STATUS_PIN=13
